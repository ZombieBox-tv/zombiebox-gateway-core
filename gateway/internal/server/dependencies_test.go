...
func testDependencies() Dependencies {
	...
	return Dependencies{Artwork: artwork.New(httpclient.Metadata()), Catalog: adapters, Search: adapters, Resolver: adapters, Player: adapters, Browser: adapters, ControlHTTP: httpclient.Private(), StreamHTTP: httpclient.Streaming()}
}
